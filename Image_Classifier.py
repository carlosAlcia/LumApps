# Image classifier using PyTorch and the CIFAR10 dataset.
# This code is extracted from https://pytorch.org/tutorials/beginner/blitz/cifar10_tutorial.html.
# Modified by Carlos Alvarez Cia 2024.
